...
def get_sample_info():
    ...
    if(sample_box=="Box_Zener"):
        ...
        while((sample != "Res_1") and (sample != "Res_2") and (sample != "Res_3") and \
            ...
            (sample != "Res_16") and (sample != "Res_17") and (sample != "Res_18") and \
            (sample != "Res_19") and (sample != "Res_20") and (sample != "Res_21") and \
            (sample != "Res_22") and (sample != "Res_23") and (sample != "Res_24") and (sample != "Res_25")):
            sample = raw_input("\nSelect sample : (Res_1,Res_2,Res_3,Res_4,Res_5,Res_6,Res_7, Res_8,Res_9,Res_10,Res_11,Res_12,Res_13,Res_14,Res_15,Res_16,Res_17,Res_18,Res_19,Res_20,Res_21,Res_22,Res_23,Res_24,Res_25)\n")
